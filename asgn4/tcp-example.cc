...
main (int argc, char *argv[])
{
  ...
  std::string bandwidth1 = "10Mbps";
  std::string delay1 = "100ms";
  std::string bandwidth2 = "7Mbps";
  std::string delay2 = "10ms";
  ...
  //set tcp buffer sizes for sender (node 0) and reciever (node2)
  ...
  pointToPoint.SetDeviceAttribute ("DataRate", StringValue (bandwidth1));
  ...
  pointToPoint2.SetDeviceAttribute ("DataRate", StringValue (bandwidth2));
  ...
  //application payload size is 1460 bytes
